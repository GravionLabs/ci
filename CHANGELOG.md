...
### Bug Fixes
- Replace unsupported --skip-existing with --check-url in uv publish


### Documentation
- Update CHANGELOG.md for v1.0.41 [skip ci]
...
### Bug Fixes
- Set package version from GitVersion before publish (#15)


### Documentation
- Update CHANGELOG.md for v1.0.39 [skip ci]
